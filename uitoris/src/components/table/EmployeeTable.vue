<template>
  <div>
    <router-link to="/employee/add"
      ><b-button variant="outline-primary" size="sm">Add Employee</b-button></router-link
    >
    ...
    >
      ...
      <template #cell(actions)="row">
        <b-button
          ...
          class="mr-2"
          size="sm"
          @click="EditEmployee(row.item.id)"
    ...
    <b-modal ref="myModalRef" hide-footer :title="infoModaltitle">
      ...
      <div class="float-right pt-4">
        <b-btn type="submit" variant="outline-danger" @click="DeleteEmployee"
          >Delete</b-btn
        >
      </div>
...
export default {
  ...
  computed: {
    ...
    ...mapState({ items: (state) => state.employee.employeeall }),
    ...mapState({ totalRows: (state) => state.employee.count }),
    csvData() {
