...
router.register(r'states', StatesViewSets)
router.register(r'districts',DistrictsViewSets)
router.register(r'customers',CustomersViewSets)
...
urlpatterns = [
    ...
    path('pro_report/',ProductionOrderReportView.as_view()),
