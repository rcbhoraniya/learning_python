...
def invoice_data_validator(invoice_data):
    ...
    if len(invoice_data['customer-city']) > 100:
    ...
    if len(invoice_data['customer-email']) > 50:
...
def invoice_data_processor(invoice_post_data):
    ...
    processed_invoice_data['customer_id'] = invoice_post_data['customer-id']
    ...
    processed_invoice_data['customer_city'] = invoice_post_data['customer-city']
    processed_invoice_data['customer_email'] = invoice_post_data['customer-email']
    ...
    processed_invoice_data['invoice_veh'] = invoice_post_data['vehicle-number']
    processed_invoice_data['invoice_eway'] = invoice_post_data['eway-number']
    processed_invoice_data['invoice_lrno'] = invoice_post_data['lr-number']
    processed_invoice_data['invoice_po'] = invoice_post_data['po-number']
    processed_invoice_data['invoice_challan'] = invoice_post_data['challan-number']
